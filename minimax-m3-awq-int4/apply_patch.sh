...
declare -A FILE_MAP=(
  ...
  # EAGLE3 verify graph-safety: torch.full-built extend_seq_lens temp tensor
  # must not be GC'd between cuda graph capture and replay, else bs>=16 VMFault.
  # See memory/m3-verify-graph-temp-tensor-rootcause.md.
