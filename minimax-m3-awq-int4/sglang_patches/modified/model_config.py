...
def get_minimax_sparse_attention_config(config: PretrainedConfig) -> dict:
    # [FIX Bug A] text_config may be a PreTrainedConfig object OR a plain dict.
    ...
    # layer_types 在 text_config (非顶层 config), 必须从 text_config 取。
